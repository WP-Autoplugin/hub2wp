...
class GPB_Admin_Ajax {
	...
	public function get_plugin_details() {
		...
		$data = array(
			...
			'watchers'       => isset( $repo_details['watchers_count'] ) ? number_format_i18n( $repo_details['watchers_count'] ) : '0',
			...
			'version'        => isset( $repo_details['default_branch'] ) ? sanitize_text_field( $repo_details['default_branch'] ) : '',
